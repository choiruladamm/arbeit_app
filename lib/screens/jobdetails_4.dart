...
class JobDetailsPapat extends StatelessWidget {
  const JobDetailsPapat({super.key});
        ...
        child: Column(
          ...
          children: [
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: NetworkImage(
                          "${contentRecommended.elementAt(3)['logos']}",
                          scale: 9,
                        ),
                      ),
                    ),
                  ...
                  Column(
                    ...
                    children: [
                      Text(
                        "${contentRecommended.elementAt(3)['subjobstitle']}",
                        style: TextStyle(
                          fontSize: 16,
                      ...
                      SizedBox(height: 5),
                      Text(
                        "${contentRecommended.elementAt(3)['company']}",
                        style: TextStyle(
                          color: Colors.grey,
                          fontSize: 14,
                  ...
                  Row(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          "${contentRecommended.elementAt(3)['timework']}",
                          style: TextStyle(
                            fontSize: 14,
                            fontWeight: FontWeight.w500,
                          ),
                  ...
                  Row(
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsets.only(left: 15),
                        child: Text(
                          "${contentRecommended.elementAt(3)['locationwork']}",
                          style: TextStyle(
                            fontSize: 14,
                            fontWeight: FontWeight.w500,
                          ),
                  ...
                  Row(
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsets.only(left: 15),
                        child: Text(
                          "${contentRecommended.elementAt(3)['salary']}",
                          style: TextStyle(
                            fontSize: 14,
                            fontWeight: FontWeight.w500,
                          ),
            ...
            Padding(
              ...
              child: Text(
                "${contentRecommended.elementAt(3)['jobdesc']}",
                style: TextStyle(
                  fontSize: 12,
                ),
              ),

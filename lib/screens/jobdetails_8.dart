...
class JobDetailsWolu extends StatelessWidget {
  const JobDetailsWolu({super.key});
        ...
        child: Column(
          ...
          children: [
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: NetworkImage(
                          "${contentRecommended.elementAt(7)['logos']}",
                          scale: 9,
                        ),
                      ),
                    ),
                  ...
                  Column(
                    ...
                    children: [
                      Text(
                        "${contentRecommended.elementAt(7)['subjobstitle']}",
                        style: TextStyle(
                          fontSize: 16,
                      ...
                      SizedBox(height: 5),
                      Text(
                        "${contentRecommended.elementAt(7)['company']}",
                        style: TextStyle(
                          color: Colors.grey,
                          fontSize: 14,
                  ...
                  Row(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          "${contentRecommended.elementAt(7)['timework']}",
                          style: TextStyle(
                            fontSize: 14,
                            fontWeight: FontWeight.w500,
                          ),
                  ...
                  Row(
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsets.only(left: 15),
                        child: Text(
                          "${contentRecommended.elementAt(7)['locationwork']}",
                          style: TextStyle(
                            fontSize: 14,
                            fontWeight: FontWeight.w500,
                          ),
                  ...
                  Row(
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsets.only(left: 15),
                        child: Text(
                          "${contentRecommended.elementAt(7)['salary']}",
                          style: TextStyle(
                            fontSize: 14,
                            fontWeight: FontWeight.w500,
                          ),
            ...
            Padding(
              ...
              child: Text(
                "${contentRecommended.elementAt(7)['jobdesc']}",
                style: TextStyle(
                  fontSize: 12,
                ),
              ),
